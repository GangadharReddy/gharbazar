...
function fun1()
{
	...
	if(category=="select Ad Category")
		{
...
<form id="contact-form" action="./fileuploadservlet?health=<%=reg%>" method="post" enctype="multipart/form-data" onsubmit="return validation(this)">
   ...
   <label>Home and Life Style</label></h1>
   </div>
...
<label>
	...
	<select name="sltmodel" id="txtcategory">
        <option>select Ad Category</option>  
 		<option>Health-BeautyFitness</option>
  		<option>Therapy</option>
  		<option>DoctorDetails</option>
...
<label>
	<span>Details</span>
 		<textarea style="resize:none;"  name="txtdetails" id="txtdetail"></textarea>
...
<label>
 ...
 <div><center>
 	<input type="submit" name="btnhealth" value="Submit" onclick="return fun1();">
