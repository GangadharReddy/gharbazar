...
%>
	...
	<div id="container">
		<div id="link">
			<div id="linkleft"><a href="homepage.jsp">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Home &nbsp; <b>&gt;</b> &nbsp; </a><a href="./healthservlet?back=1">Home and LifeStyle &nbsp;<b> &gt;</b> &nbsp; </a><a href="#"><%out.println(bean.getProductname()); %></a></div>
		...
		<div id="contact">
			...
			<div id="email" style="margin-left: 5px;"><h3><img src="./images/email.png"/><%out.println(bean.getEmail()); %></h3></div>
		</div>
	</div>
	<div id="rightcon"></div>
	<% } %>
