...
<form name="frmrealestate" action="./realestateservlet">
...
<%
  ...
  <tr>
    <td><input type="checkbox" id="chk1" name="chkmobile" value="Sell">Sell</td>
  </tr>
  <tr>
    <td><input type="checkbox" id="chk2" name="chkmobile" value="Rent" >Rent</td>
  </tr>
  <tr>
    <td><input type="checkbox" id="chk3" name="chkmobile" value="Residential" >Residential</td>
  </tr>
  <tr>
    <td><input type="checkbox" id="chk4" name="chkmobile" value="Commercial" >Commercial</td>
  </tr>
...
for(i=0; i<view.size(); i++){
	...
	<div style="width:384px; height:134px; float:left; margin:3px;">
		<div style="width:380px;height:80px;float:left; margin:2px;"><br><br>
			<h3 style="text-align: left; padding:10px;">  <a href="./productInfoservlet?productinforealestate=<%=s1.getS_id()%>"><%out.println(s1.getProductname()); %></a>  </h3>
		</div>
		<div style="width:380px; height:46px; float:left; margin:2px;">
			<h4 style="text-align: left; padding:10px;"><%out.println(s1.getLocation()); %> &nbsp; |&nbsp; <% out.println(s1.getCity());%>&nbsp; | &nbsp;Real Estate</h4>
		</div>
	</div>
