...
<form name="frmelectronics" action="vehicleservlet">
<div id="header" ><a href="./homepage.jsp"><img src="./images/logo1.gif" id="logo" alt="GharBazar.com"></a>
  ...
  <tr>
    <td><input type="checkbox" name="chkele" id="chk1" value="ITPeripherals">ITPeripherals</td>
  </tr>
  <tr>
    <td><input type="checkbox" name="chkele" id="chk2" value="TVCameraAndMultimedia" >TVCameraAndMultimedia</td>
  </tr>
  <tr>
    <td><input type="checkbox" name="chkele" id="chk3" value="HomeAppliances" >HomeAppliances</td>
  </tr>
  <tr>
    <td><input type="checkbox" name="chkele" id="chk4" value="IndustrialMachineryT" >IndustrialMachineryT</td>
  </tr>
  <tr>
    <td><input type="checkbox" id="chk5" name="chkele" value="Others" >Others</td>
  </tr>
  <br><br>
  <tr>
      <td><input type="checkbox" id="chk6" name="chkele" value="All">All</td>
	</tr>
<tr>
  	<td align="center"><input type="submit" value="Find" name="btnefind" onclick="return validate();"></td>
  </tr>
...
<td><hr size="3" color="black"></td>
    ...
    <tr>
    <td><input type="checkbox" id="chk7"name="chkeprice" value="2000">&#x20b9;&nbsp;2000 and Below</td>
  </tr>
  <tr>
    <td><input type="checkbox" id="chk8"name="chkeprice" value="2001">&#x20b9;&nbsp;2001 - &#x20b9;&nbsp;5000</td>
  </tr>
  <tr>
    <td><input type="checkbox" id="chk9"name="chkeprice" value="5001">&#x20b9;&nbsp;5001 - &#x20b9;&nbsp;10000</td>
  </tr>
  <tr>
    <td><input type="checkbox" id="chk10" name="chkeprice" value="10001">&#x20b9;&nbsp;10001 - &#x20b9;&nbsp;18000</td>
  </tr>
  <tr>
    <td><input type="checkbox" id="chk11" name="chkeprice" value="18001">&#x20b9;&nbsp;18001 - &#x20b9;&nbsp;25000</td>
  </tr> 
  <tr>
    <td><input type="checkbox" id="chk12" name="chkeprice" value="25001">&#x20b9;&nbsp;25001 - &#x20b9;&nbsp;35000</td>
  </tr>
  <tr>
    <td><input type="checkbox" id="chk13" name="chkeprice" value="35001">Rs. 35001 and Above</td>
  </tr>
  <tr>
    <td><input type="checkbox"id="chk14" name="chkeprice" value="all">ALL</td>
  </tr>
  <tr>
    <td><input type="submit" name="btnpefind" value="Find" onclick="return validate();"></td>
  </tr>
...
<div style="width:890px; height:140px;margin:5px;float:left;">
	...
	<div style="width:384px; height:134px; float:left; margin:3px;">
		<div style="width:380px;height:80px;float:left; margin:2px;"><br><br>
			<h3 style="text-align: left; padding:10px;">  <a href="./productInfoservlet?productinfoelectronics=<%=s1.getS_id()%>"><%out.println(s1.getProductname()); %></a>  </h3>
		</div>
