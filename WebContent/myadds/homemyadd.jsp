...
<div id="hedderbelow"></div>
  ...
  <tr>
    ...
    <li><a href="../myaddservlet?health=true&reg=<%=reg %>" class="arrow">Home and Life Sytle</a>
  ...
  <img src="../images/electronics and technology/images.jpg" height="150" width="200" /> </td>
    ...
    <li><a href="../myaddservlet?mobile=true&reg=<%=reg%>" class="arrow">Mobiles</a>
  ...
  <img src="../images/mobile/1.jpg" height="150" width="200" /> </ul></td>
    ...
    <li><a href="../myaddservlet?view=1" class="arrow" >View Profile</a>
  ...
  <tr>
    ...
    <li><a href="../myaddservlet?vehicles=true&reg=<%=reg%>" class="arrow">Vehicles</a>
  ...
  <img src="../images/vehicles/images (2).jpg" height="150" width="200" /></td>
    ...
    <li><a href="../myaddservlet?itperipherals=true&reg=<%=reg%>" class="arrow">Electronics</a>
  ...
  <img src="../images/electronics and technology/images (5).jpg" height="150" width="200" /> </td>
    ...
    <li><a href="../myaddservlet?rrent=true&reg=<%=reg%>" class="arrow">Real Estate</a>
