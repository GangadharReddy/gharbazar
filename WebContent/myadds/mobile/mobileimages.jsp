...
<form name="frmfileupload" action="maruadmintaru">
<div id="header" ><input type="submit" value="Delete" name="btndeletemobile"><a href="#"><img src="#" id="logo" alt="Affable Bean logo"></a><img src="#" id="logoText" alt="GharBazaar.com">
<input type="submit" name="btnbuy" value="BUY"><input type="submit" name="btnsell" value="SELL"> 
     <input type="button"   id="btnpostyouradds" value="post your adds here" style="font-size:24px;"/></div>
     <div id="left">
  ...
  <tr>
    <td><input type="checkbox" name="chkmobile" value="AndroidPhones">AndroidPhones</td>
  </tr>
  <tr>
    <td><input type="checkbox" name="chkmobile" value="SmartPhones" >SmartPhones</td>
  </tr>
  <tr>
    <td><input type="checkbox" name="chkmobile" value="DualSimPhones" >DualSimPhones</td>
  </tr>
  <tr>
    <td><input type="checkbox" name="chkmobile" value="BussinessPhones" >BussinessPhones</td>
  </tr>
  <tr>
    <td><input type="checkbox" name="chkmobile" value="ValuePhones" >ValuePhones</td>
  </tr>
  <tr>
    <td><input type="checkbox" name="chkmobile" value="Tablets">Tablets</td>
  </tr>
  <tr>
    <td><input type="checkbox" name="chkmobile" value="WindowPhones" >WindowPhones</td>
  </tr>
  <br><br>
  <tr>
...
<tr>
  	<td align="center"><input type="submit" value="Find" name="btnmfind"></td>
  </tr>
...
<td><hr size="3" color="black"></td>
  ...
  <tr>
    <td><input type="submit" name="btnpmfind" value="Find"></td>
  </tr>
...
for(i=0; i<view.size(); i++){
  ...
  <tr>
    <td height="57"><h3>  <a href="./productInfoservlet?productinfoadmin=<%=s1.getS_id()%>"><%out.println(s1.getProductname()); %></a>  </h3></td>
  </tr>
  <tr>
    <td><%out.println(s1.getLocation()); %>  | <% out.println(s1.getCity());%> | Mobile Phone</td>
  </tr>
</table>
</td>
...
<div id="footer">All Rights Reserved &copy;&nbsp;2014&nbsp;|&nbsp;<a class='ajax'  class="ahover" href="aboutUs.jsp" title="GharBazar" style="text-decoration: none;">About Us</a>&nbsp;|&nbsp;
	<a class='ajax'  class="ahover" href="privacyPolicy.jsp" title="GharBazar" style="text-decoration: none;">Privacy Policy</a><input type="submit" value="Delete" name="btndeletemobile"></div>	
