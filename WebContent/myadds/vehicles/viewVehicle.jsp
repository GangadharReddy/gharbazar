...
<form name="frmvehicle" action="maruadmintaru">
<div id="header" ><input type="submit" value="Delete" name="btndeletevehicle"><a href="#"><img src="#" id="logo" alt="Affable Bean logo"></a><img src="#" id="logoText" alt="GharBazaar.com">
</div>
     <div id="left">
  ...
  <tr>
    <td><input type="checkbox" name="chkmobile" value="Buy">Buy</td>
  </tr>
  <tr>
    <td><input type="checkbox" name="chkmobile" value="Sell" >Sell</td>
  </tr>
  <tr>
    <td><input type="checkbox" name="chkmobile" value="Vehicles" >Vehicles</td>
  </tr>
  <tr>
    <td><input type="checkbox" name="chkmobile" value="VehicleAccessories" >Vehicle Accessories</td>
  </tr>
...
<tr>
  	<td align="center"><input type="submit" value="Find" name="btnvfind"></td>
  </tr>
...
<td><hr size="3" color="black"></td>
  ...
  <tr>
    <td><input type="submit" name="btnpvfind" value="Find"></td>
  </tr>
...
for(i=0; i<view.size(); i++){
  ...
  <tr>
    <td height="57"><h3>  <a href="./productInfoservlet?productinfovehiadmin=<%=s1.getS_id()%>"><%out.println(s1.getProductname()); %></a>  </h3></td>
  </tr>
  <tr>
    <td><%out.println(s1.getLocation()); %>  | <% out.println(s1.getCity());%> | Vehicles</td>
  </tr>
</table>
</td>
...
<div id="footer">All Rights Reserved &copy;&nbsp;2014&nbsp;|&nbsp;<a class='ajax'  class="ahover" href="aboutUs.jsp" title="GharBazar" style="text-decoration: none;">About Us</a>&nbsp;|&nbsp;
	<a class='ajax'  class="ahover" href="privacyPolicy.jsp" title="GharBazar" style="text-decoration: none;">Privacy Policy</a><input type="submit" value="Delete" name="btndeletevehicle"></div>	
