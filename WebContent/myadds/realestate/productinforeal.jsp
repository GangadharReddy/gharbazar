...
<div id="middle">
	...
	<div id="middleupper"><div id="middleupperleft"></div><div id="middleuppermiddle"><a href="Admin/homeadmin.jsp">Home > </a><a href="./maruadmintaru?all=1">Real Estate > </a><a href="#"><%out.println(bean.getProductname()); %></a></div><div id="middleupperright"><a href="./productInfoservlet?prevreal=<%=bean.getS_id()%>">Prev. Ad  </a>  <a href="./productInfoservlet?nextreal=<%=bean.getS_id()%>">   Next Ad</a></div></div>
