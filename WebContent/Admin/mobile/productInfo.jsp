...
<div id="leftcon"></div>
	<div id="container">
		<div id="link">
			<div id="linkleft"><a href="homeadmin.jsp">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Home &nbsp; <b>&gt;</b> &nbsp; </a><a href="./maruadmintaru?mobile=1">Mobile &nbsp;<b> &gt;</b> &nbsp; </a><a href="#"><%out.println(bean.getProductname()); %></a></div>
			<div id="linkright"><a href="./productInfoservlet?prev=<%=bean.getS_id()%>"><b>&lt;</b> &nbsp;Previous Ad &nbsp;&nbsp; </a>  <a href="./productInfoservlet?next=<%=bean.getS_id()%>">  &nbsp; Next Ad &nbsp;<b>&gt;</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></div>
