...
<form name="frmhealth" action="maruadmintaru">
<div id="header" >
...
<tr>
  	<td align="center"><input type="submit" value="Find" name="btnfind" style="background: #D40000;"></td>
  </tr>
...
for(i=0; i<view.size(); i++){
  ...
  <tr>
    <td height="57"><h3>  <a href="./productInfoservlet?productinfohealthadmin=<%=s1.getS_id()%>"><%out.println(s1.getProductname()); %></a>  </h3></td>
  </tr>
  <tr>
    <td><%out.println(s1.getLocation()); %>  | <% out.println(s1.getCity());%> | Home and Life Style</td>
  </tr>
</table>
</td>
...
<div id="right"><br><br><input type="submit" value="Delete" name="btndelete" style="width:80px;height:30px; border:2px solid blue; background:blue;border-radius:5px;"></div>
<div id="footerup"></div>
