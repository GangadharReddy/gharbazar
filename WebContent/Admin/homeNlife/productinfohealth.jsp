...
<div id="leftcon"></div>
	<div id="container">
		<div id="link">
			<div id="linkleft"><a href="Admin/homeadmin.jsp">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Home &nbsp; <b>&gt;</b> &nbsp; </a><a href="./maruadmintaru?backk=1">Home and LifeStyle &nbsp;<b> &gt;</b> &nbsp; </a><a href="#"><%out.println(bean.getProductname()); %></a></div>
			<div id="linkright"><a href="./productInfoservlet?prevhealth=<%=bean.getS_id()%>"><b>&lt;</b> &nbsp;Previous Ad &nbsp;&nbsp; </a>  <a href="./productInfoservlet?nexthealth=<%=bean.getS_id()%>">  &nbsp; Next Ad &nbsp;<b>&gt;</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></div>
		...
		<div id="titleprice">
			...
			<div id="details">
				...
				<div id="det">
					<h3><% out.println(bean.getLocation()); %> &nbsp; | &nbsp;  <%out.println(bean.getDetails());%> &nbsp;  | &nbsp;  <%out.println(bean.getMobiletype()); %></h3>
				</div>
			</div>
			<div id="price">
		...
		<div id="contact">
			<div id="name"><h2><%out.println(bean.getFname());%>  <%out.println(bean.getLname()); %></h2></div>
			<div id="con"><h2><%out.println(bean.getContactno()); %></h2></div>
			<div id="email"><h3><%out.println(bean.getEmail()); %></h3></div>
		</div>
	</div>
	<div id="rightcon"></div>
	<% } %>
