...
<a href="./seller/addPost.jsp" class="myButton">Post Your Ads Here
...
<div id="leftcon"></div>
	<div id="container">
		<div id="link">
			<div id="linkleft"><a href="Admin/homeadmin.jsp">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Home &nbsp; <b>&gt;</b> &nbsp; </a><a href="./maruadmintaru?all=1">Real Estate &nbsp;<b> &gt;</b> &nbsp; </a><a href="#"><%out.println(bean.getProductname()); %></a></div>
			<div id="linkright"><a href="./productInfoservlet?prevreal=<%=bean.getS_id()%>"><b>&lt;</b> &nbsp;Previous Ad &nbsp;&nbsp; </a>  <a href="./productInfoservlet?nextreal=<%=bean.getS_id()%>">  &nbsp; Next Ad &nbsp;<b>&gt;</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></div>
