...
<div id="header" ><input type="submit" value="Delete" name="btndeleteele">
...
for(i=0; i<view.size(); i++){
  ...
  <tr>
    <td height="57"><h3>  <a href="./productInfoservlet?productinfoeleadmin=<%=s1.getS_id()%>"><%out.println(s1.getProductname()); %></a>  </h3></td>
  </tr>
  <tr>
    <td><%out.println(s1.getLocation()); %>  | <% out.println(s1.getCity());%> | Electronics</td>
  </tr>
</table>
</td>
