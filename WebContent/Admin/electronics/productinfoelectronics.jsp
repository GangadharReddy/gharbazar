...
<div id="leftcon"></div>
	<div id="container">
		<div id="link">
			<div id="linkleft"><a href="adminhome.jsp">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Home &nbsp; <b>&gt;</b> &nbsp; </a><a href="maruadmintaru?ele_others=1">Electronics &nbsp;<b> &gt;</b> &nbsp; </a><a href="#"><%out.println(bean.getProductname()); %></a></div>
			<div id="linkright"><a href="./productInfoservlet?prevele=<%=bean.getS_id()%>"><b>&lt;</b> &nbsp;Previous Ad &nbsp;&nbsp; </a>  <a href="./productInfoservlet?nextele=<%=bean.getS_id()%>">  &nbsp; Next Ad &nbsp;<b>&gt;</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></div>
