...
function validate()
{
	...
	var chk14=document.getElementById("chk14").checked;
	var chk15=document.getElementById("chk15").checked;
	var chk16=document.getElementById("chk16").checked;
	
	
		
		if(chk1||chk2||chk3||chk4||chk5||chk6||chk7||chk8||chk9||chk10||chk11||chk12||chk13||chk14||chk15||chk16)
...
<form name="frmfileupload" action="fileuploadservlet">
...
<%
  ...
  <tr>
    <td><b>MOBILE TYPES</b></td>
  </tr>
  <tr>
    <td><input type="checkbox" id="chk1" name="chkmobile" value="AndroidPhones">AndroidPhones</td>
  </tr>
  <tr>
    <td><input type="checkbox" id="chk2" name="chkmobile" value="SmartPhones" >SmartPhones</td>
  </tr>
  <tr>
    <td><input type="checkbox" id="chk3" name="chkmobile" value="DualSimPhones" >DualSimPhones</td>
  </tr>
  <tr>
    <td><input type="checkbox" id="chk4" name="chkmobile" value="BussinessPhones" >BussinessPhones</td>
  </tr>
  <tr>
    <td><input type="checkbox" id="chk5" name="chkmobile" value="ValuePhones" >ValuePhones</td>
  </tr>
  <tr>
    <td><input type="checkbox" id="chk6" name="chkmobile" value="Tablets">Tablets</td>
  </tr>
  <tr>
    <td><input type="checkbox" id="chk7" name="chkmobile" value="WindowPhones" >WindowPhones</td>
  </tr>
  <br><br>
  <tr>
      <td><input type="checkbox" id="chk8" name="chkmobile" value="All">All</td>
	</tr>
<tr>
...
<td><hr size="3" color="black"></td>
    ...
    <tr>
    <td><input type="checkbox" id="chk9" name="chkprice" value="2000">&#x20b9;&nbsp;2000 and Below</td>
  </tr>
  <tr>
    <td><input type="checkbox" id="chk10" name="chkprice" value="2001">&#x20b9;&nbsp;2001 - &#x20b9;&nbsp;5000</td>
  </tr>
  <tr>
    <td><input type="checkbox" id="chk11" name="chkprice" value="5001">&#x20b9;&nbsp;5001 - &#x20b9;&nbsp;10000</td>
  </tr>
  <tr>
    <td><input type="checkbox" id="chk12" name="chkprice" value="10001">&#x20b9;&nbsp;10001 - &#x20b9;&nbsp;18000</td>
  </tr>
  <tr>
    <td><input type="checkbox" id="chk13" name="chkprice" value="18001">&#x20b9;&nbsp;18001 - &#x20b9;&nbsp;25000</td>
  </tr>
  <tr>
    <td><input type="checkbox" id="chk14" name="chkprice" value="25001">&#x20b9;&nbsp;25001 - &#x20b9;&nbsp;35000</td>
  </tr>
  <tr>
    <td><input type="checkbox" id="chk15" name="chkprice" value="35001">&#x20b9;&nbsp;35001 and Above</td>
  </tr>
  <tr>
    <td><input type="checkbox" id="chk16" name="chkpriceall" value="all">ALL</td>
  </tr>
  <tr>
...
for(i=0; i<view.size(); i++){
	...
	<div style="width:384px; height:134px; float:left; margin:3px;">
		<div style="width:380px;height:80px;float:left; margin:2px;"><br><br>
			<h3 style="text-align: left; padding:10px;">  <a href="./productInfoservlet?productinfo=<%=s1.getS_id()%>"><%out.println(s1.getProductname()); %></a>  </h3>
		</div>
		<div style="width:380px; height:46px; float:left; margin:2px;">
			<h4 style="text-align: left; padding:10px;"><%out.println(s1.getLocation()); %> &nbsp; |&nbsp; <% out.println(s1.getCity());%>&nbsp; | &nbsp;Mobile Phone</h4>
		</div>
	</div>
